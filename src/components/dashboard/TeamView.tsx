...
export default function TeamView() {
  ...
  const handleSavePartner = async (data: { name: string; description: string; image: string; mou?: string }) => {
    if (editPartner?.id) {
  ...
  const handleAddPartner = async (data: { name: string; description: string; image: string; mou?: string }) => {
