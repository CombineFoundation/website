...
export default function PartnersSection({ partners: dbPartners }: PartnersSectionProps) {
  const displayPartners: Partner[] = dbPartners.length > 0
    ? dbPartners.map((p, index) => ({
