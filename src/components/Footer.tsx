...
export default function Footer() {
  return (
    <footer className="bg-secondary-700 text-white relative overflow-hidden py-16 px-4 md:px-8 mt-auto">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 relative z-10">
        ...
        <div className="md:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-8 pt-4">
          ...
          <div className="flex flex-col space-y-4">
            <h3 className="text-accent-orange font-black text-lg mb-2">Quick Links</h3>
          ...
          {/* Donate */}
          <div className="flex flex-col space-y-4">
            <h3 className="text-accent-orange font-black text-lg mb-2">Donate</h3>
          ...
          {/* Support */}
          <div className="flex flex-col space-y-4">
            <h3 className="text-accent-orange font-black text-lg mb-2">Support</h3>
